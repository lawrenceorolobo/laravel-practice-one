...
<body class="min-h-screen bg-slate-900 flex items-center justify-center p-6">
    ...
    <div class="text-center max-w-md">
        ...
        <!-- Actions -->
        <div class="space-y-3">
            <button onclick="window.location.reload()" class="block w-full py-4 bg-indigo-600 text-white rounded-xl font-bold text-lg hover:bg-indigo-700 hover:shadow-lg hover:-translate-y-0.5 transition-all">
                Refresh Page
            </button>
